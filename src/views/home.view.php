...
<body class="bg-gray-100 font-sans">
    ...
    <main class="py-16">
        <section class="container mx-auto px-6 md:px-12 text-center">
            <h1 class="text-5xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-green-400 mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
                <!-- Profesores -->
                <a href="/teachers" class="group bg-white shadow-lg rounded-lg p-6 hover:shadow-2xl transform hover:-translate-y-2 transition">
                ...
                <!-- Estudiantes -->
                <a href="/students" class="group bg-white shadow-lg rounded-lg p-6 hover:shadow-2xl transform hover:-translate-y-2 transition">
                    <div class="flex flex-col items-center">
                ...
                <!-- Departamentos -->
                <a href="/departments" class="group bg-white shadow-lg rounded-lg p-6 hover:shadow-2xl transform hover:-translate-y-2 transition">
                    <div class="flex flex-col items-center">
                ...
                <!-- Cursos -->
                <a href="/courses" class="group bg-white shadow-lg rounded-lg p-6 hover:shadow-2xl transform hover:-translate-y-2 transition">
                    <div class="flex flex-col items-center">
                ...
                <!-- Grado -->
                <a href="/degrees" class="group bg-white shadow-lg rounded-lg p-6 hover:shadow-2xl transform hover:-translate-y-2 transition">
                    <div class="flex flex-col items-center">
                        ...
                        <h3 class="text-lg font-bold text-gray-800">Grado</h3>
